...
import heroImg from "@/assets/product-pvc-aluminio.jpg";
            ...
            <main className="pt-20">
                <section className="container py-12 md:py-24 grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="aspect-video bg-muted rounded-xl overflow-hidden relative shadow-xl">
                        ...
                        <img src={heroImg} alt="Ventanas de PVC y Aluminio" className="w-full h-full object-cover" />
                    </div>
                </section>
            </main>
            <Footer />
...
export default PvcAluminioPage;
